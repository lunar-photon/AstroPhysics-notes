...
\begin{align}
	 dt&=\int_{r_0}^{r}\frac{1}{\sqrt{GM}}\int_{r_0}^{r}\frac{r'\,dr'}{\left(2r'-r'^2/a-\lambda\right)^{1/2}}\\
	t-t_0&=\sqrt{a}\int_{r_0}^{r}\frac{rdr}{\sqrt{a^2e^2-(r-a)^2}}\tag{using $\lambda=a(1-e^2)$}
\end{align}
