...
\subsection{Central force problem}
	...
	\begin{tcolorbox}[breakable]
		Since $\vec{A}\cdot\vec{L}=0$ and $$\abs{\vec{A}}=\sqrt{\mu^2 G^2 M_{\rm tot}^2+2\mu EL^2}$$
		So $\vec{A}$ does not supply three independent conditions as it already constrained by $E$ and $\vec{L}$.
	\end{tcolorbox}
